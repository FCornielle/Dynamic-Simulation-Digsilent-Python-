...
# voltage - bus_dict['Bus 1'].GetAttribute('m:u')
...
"""
Shc_folder.CreateObject('EvtParam', 'parameter event')
...
evt.value = '1.05'
evt.Delete()
app.ResetCalculation() # Don't forget to reset in dynamic simulations
"""